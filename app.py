...
def create_app():
    ...
    from routes.mensajeria      import mensajeria_bp     # ⚠️ Nuevo 29/04/2026
    from routes.obsolescencia   import obsolescencia_bp  # ⚠️ Nuevo 29/04/2026
    ...
    app.register_blueprint(mensajeria_bp)                # ⚠️ Nuevo 29/04/2026
    app.register_blueprint(obsolescencia_bp)             # ⚠️ Nuevo 29/04/2026
